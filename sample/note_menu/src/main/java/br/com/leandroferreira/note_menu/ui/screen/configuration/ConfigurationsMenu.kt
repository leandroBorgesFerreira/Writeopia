package br.com.leandroferreira.note_menu.ui.screen.configuration
...
private fun ArrangementOptions(listOptionClick: () -> Unit, gridOptionClick: () -> Unit) {
    Row(
        ...
        Icon(
            ...
            contentDescription = stringResource(br.com.leandroferreira.resourcers.R.string.staggered_card),
