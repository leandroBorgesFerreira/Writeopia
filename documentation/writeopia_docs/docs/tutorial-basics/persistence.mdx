...
![Maven Central](https://img.shields.io/maven-central/v/com.github.leandroborgesferreira/writeopia-persistence)

The SDK has a persistence plugin. First add the plugin:

```kotlin
// This will change to implementation("io.writeopia:writeopia-persistence:[version]") in next version
