...
internal val FolderSync: ImageVector
	get() {
		if (_FolderSync != null) {
			return _FolderSync!!
		}
		_FolderSync = ImageVector.Builder(
            name = "io.writeopia.common.utils.icons.getFolderSync",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
			...
			path(
				...
				arcToRelative(5f, 5f, 0f, isMoreThanHalf = false, isPositiveArc = true, 8f, 1.5f)
			}
			path(
    			fill = null,
    			fillAlpha = 1.0f,
