Pod::Spec.new do |spec|
    spec.name                     = 'writeopia'
    spec.version                  = '1.0'
    spec.homepage                 = 'https://github.com/leandroBorgesFerreira/Writeopia'
    spec.source                   = { :http=> ''}
    spec.authors                  = ''
    spec.license                  = ''
    spec.summary                  = 'Common'
    ...
    if !Dir.exist?('build/cocoapods/framework/common.framework') || Dir.empty?('build/cocoapods/framework/common.framework')
        ...
        'pod install' should be executed after running ':generateDummyFramework' Gradle task:
            ...
            ./gradlew :writeopia:generateDummyFramework

        Alternatively, proper pod installation is performed during Gradle sync in the IDE (if Podfile location is set)"
    end
                
    spec.pod_target_xcconfig = {
        'KOTLIN_PROJECT_PATH' => ':writeopia',
        'PRODUCT_MODULE_NAME' => 'common',
    }
                
    spec.script_phases = [
        {
            :name => 'Build writeopia',
