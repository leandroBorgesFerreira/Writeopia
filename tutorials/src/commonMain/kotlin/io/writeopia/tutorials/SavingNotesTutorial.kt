...
internal fun savingNotesTutorial() =
"""
{
    "id": "EnxRIMrTMA",
    "title": "Saving Notes",
    ...
    "content": [
        ...
        },
        {
            ...
            "text": "You can sync the workspace to load all your notes or manually include notes individually. To include a single note, simply drag and drop your files into Writeopia, and they'll be added to the current folder.",
            "position": 10
        },
        {
            "id": "TBw8hJkLhs",
